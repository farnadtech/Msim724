...
export const simCards: SimCard[] = [
  ...
  { id: 4, number: '09128888888', price: 0, seller_id: user_ids.admin, type: 'auction', status: 'available', carrier: 'همراه اول', is_rond: true, auction_details: { end_time: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(), current_bid: 2500000, highest_bidder_id: undefined, bids: [] } },
